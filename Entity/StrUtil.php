...
class StrUtil {
    ...
    public static function utf8_strtolower($string) {
        ...
        $uni = StrUtil::utf8_to_unicode($string);
        ...
        return StrUtil::utf8_from_unicode($uni);
    }
    ...
    public static function wordExtract($text, $shortExclude = true, $toUpper = false, $unique = false, $initials = false) {
        $exclude = array('unos', 'unas', 'este', 'estos', 'esos', 'aquel', 'aquellos', 'esta', 'estas', 'esas', 'aquella', 'aquellas', 'éste', 'éstos', 'ésos', 'aquél', 'aquéllos', 'ésta', 'éstas', 'ésas', 'aquélla', 'aquéllas', 'ante', 'bajo', 'cabe', 'desde', 'contra', 'entre', 'hacia', 'hasta', 'para', 'según', 'segun', 'sobre', 'tras');
        ...
        foreach ($expl as $val) {
            ...
            if ($shortExclude && in_array($val, $exclude))
                continue;
            ...
            if ($unique && in_array($val, $wordsArr))
                continue;
